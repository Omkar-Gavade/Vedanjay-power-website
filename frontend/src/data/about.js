...
export const mission = [
  'To deliver reliable and accurate QCA services (forecasting and scheduling) for renewable-energy projects.',
...
export const milestones = [
  ...
  { year: null, name: '5,000+ MW portfolio', body: 'Built a renewable-energy QCA services (forecasting and scheduling) portfolio exceeding 5,000 MW.' },
];
...
export const achievements = [
  ...
  { name: '5,000+ MW portfolio', body: 'Managing a renewable-energy portfolio of more than 5,000 MW through QCA services (forecasting and scheduling).' },
  { name: 'Solar, wind & hybrid expertise', body: 'QCA services (forecasting and scheduling) capabilities across multiple renewable-energy technologies.' },
  ...
  { name: '24×7 operations', body: 'Continuous monitoring and operational support for renewable-energy QCA services (forecasting and scheduling).' },
