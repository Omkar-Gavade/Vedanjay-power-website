 ...
 */
export function SectionHead({ eyebrow, title, lead, id, as: Tag = 'h2', className, children }) {
  return (
    <Reveal className={cn('vp-shead', lead && 'vp-shead--split', className)}>
      ...
      <Tag id={id} className="vp-h2 vp-measure-tight mb-0 vp-shead__title">{title}</Tag>
