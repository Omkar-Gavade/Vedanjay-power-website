...
/**
 * Light/dark control. Sized as a real 44px target, styled as a quiet product
 * control rather than a novelty — the two icons cross-fade and counter-rotate.
 */
export function ThemeToggle({ className }) {
  ...
  return (
    ...
    >
      {/* Moon — shown in light mode (the action available is "go dark") */}
      ...
      <span className="visually-hidden">
        Current theme: {theme}. Activate to switch to {next}.
      </span>
    </button>
  );
}
